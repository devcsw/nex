            ...
            <div class="all_menu">
                <div class="inner">
                    <div>
                        <h2>사이트소개</h2>
                        <ul>
                            <li><a href="/EgovPageLink.do?link=main/sample_menu/EgovAboutSite">사이트소개</a></li>
                            <li><a href="/EgovPageLink.do?link=main/sample_menu/EgovHistory">연혁</a></li>
                            <li><a href="/EgovPageLink.do?link=main/sample_menu/EgovOrganization">조직소개</a></li>
                    ...
                    <div>
                        <h2>민원광장</h2>
                        <ul>
                            <li><a href="/EgovPageLink.do?link=main/sample_menu/EgovServiceManage">민원신청</a></li>
                            <li><a href="/EgovPageLink.do?link=main/sample_menu/EgovServiceResult">민원결과확인</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li><a href="/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_BBBBBBBBBBBB">자유게시판</a></li>
                        </ul>
                    </div>
