...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#deleteBoardArticle(egovframework.let.cop.bbs.brd.service.Board)
     */
     ...
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#insertBoardArticle(egovframework.let.cop.bbs.brd.service.Board)
     */
     ...
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#selectBoardArticle(egovframework.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#selectBoardArticles(egovframework.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 게시물 한 건의 내용을 수정 한다.
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#updateBoardArticle(egovframework.let.cop.bbs.brd.service.Board)
     */
     ...
     * 방명록 내용을 삭제 한다.
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#deleteGuestList(egovframework.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     * 
     * @see egovframework.let.cop.bbs.LottoService.service.EgovBBSManageService#selectGuestList(egovframework.let.cop.bbs.brd.service.BoardVO)
     */
